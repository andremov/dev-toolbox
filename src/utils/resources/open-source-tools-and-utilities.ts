...
export const openSourceToolsAndUtilities: Resource[] = [
  {
    name: 'Audacity',
  ...
  },
  {
    ...
    description: 'A collection of tools and resources for working with Flexbox layouts.',
  ...
  },
  {
    ...
    description: 'A tool for generating and manipulating PDF documents with ease.',
  ...
  },
  {
    ...
    description: 'A simple, self-hosted Git server for small teams and personal projects.',
  ...
  },
  {
    ...
    description: 'A tool for finding the right development tools for your projects.',
